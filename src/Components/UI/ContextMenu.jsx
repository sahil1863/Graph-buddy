...
const ContextMenu = ({ visible, x, y, onClose }) => {
  ...
  const menuOptionClasses =
    "cursor-pointer hover:bg-blue-600 transition-all w-full px-4";
  ...
  return (
    <div
      id="context-menu"
      style={style}
      className="bg-blue-800 pt-1 pb-2 rounded select-none flex items-center justify-center border border-blue-300 shadow-blue-400"
    >

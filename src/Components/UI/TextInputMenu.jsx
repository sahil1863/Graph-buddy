...
const TextInputMenu = ({ setIsDirected, showMessage }) => {
  ...
  return (
    <div className="bg-blue-400 px-4 py-7 flex flex-col items-center justify-center gap-y-3 rounded-md h-[50vh]">
      <div>
      ...
      <form className="flex items-center gap-x-2 justify-center h-full">
        <textarea
          ...
          cols={50}
          rows={8}
          className="bg-blue-200 border border-blue-500 px-2 py-1 resize-none focus:outline-blue-950"
        />

...
const SaveGraph = ({ setIsSaveOpen, isSaveOpen, nodes, edges, allGraphs }) => {
  ...
  return (
    <Modal openCloseHandler={setIsSaveOpen} openOrClose={isSaveOpen}>
      <div className="w-[20rem] h-[8rem] bg-blue-400 rounded-md px-4 py-2 flex items-center justify-center">
        <form
        ...
        >
          <input
            type="text"
            id="graph-name"
            className="bg-transparent outline-none border-b-[1px] border-blue-950 placeholder-blue-600 text-blue-950 px-2"

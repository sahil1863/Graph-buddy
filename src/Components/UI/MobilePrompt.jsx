    ...
    <div className="h-screen flex items-center flex-col justify-center gap-y-5">
      <h1 className="text-4xl text-center">
        <a
          ...
          rel="noreferrer"
        >
          <div className="flex text-blue-50 items-center justify-center gap-x-2 cursor-pointer">
            {" "}
            <PiGraphDuotone className="hover:scale-125 transition-all text-blue-300" />{" "}
